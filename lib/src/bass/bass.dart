...
class Bass {
  ...
  late final _BASS_GetDeviceInfoPtr = _lookup<
          ffi
          .NativeFunction<BOOL Function(DWORD, ffi.Pointer<BASS_DEVICEINFO>)>>(
      'BASS_GetDeviceInfo');
  ...
  late final _BASS_InitPtr = _lookup<
      ffi.NativeFunction<
          BOOL Function(ffi.Int, DWORD, DWORD, ffi.Pointer<ffi.Void>,
  ...
  late final _BASS_SampleCreatePtr = _lookup<
          ffi
          .NativeFunction<HSAMPLE Function(DWORD, DWORD, DWORD, DWORD, DWORD)>>(
      'BASS_SampleCreate');
  ...
  late final _BASS_StreamCreateURL = _BASS_StreamCreateURLPtr.asFunction<
      int Function(ffi.Pointer<ffi.Char>, int, int, ffi.Pointer<DOWNLOADPROC>,
  ...
  ffi.Pointer<ffi.Char> BASS_RecordGetInputName(
    int input,
  ) {
  ...
  late final _BASS_ChannelSet3DAttributesPtr = _lookup<
      ffi.NativeFunction<
          BOOL Function(DWORD, ffi.Int, ffi.Float, ffi.Float, ffi.Int, ffi.Int,
              ffi.Float)>>('BASS_ChannelSet3DAttributes');
...
typedef FILEREADPROC = ffi.NativeFunction<
    DWORD Function(ffi.Pointer<ffi.Void> buffer, DWORD length,
        ffi.Pointer<ffi.Void> user)>;
typedef FILESEEKPROC = ffi
    .NativeFunction<BOOL Function(QWORD offset, ffi.Pointer<ffi.Void> user)>;
...
typedef STREAMPROC = ffi.NativeFunction<
    DWORD Function(HSTREAM handle, ffi.Pointer<ffi.Void> buffer, DWORD length,
        ffi.Pointer<ffi.Void> user)>;
typedef DOWNLOADPROC = ffi.NativeFunction<
    ffi.Void Function(ffi.Pointer<ffi.Void> buffer, DWORD length,
        ffi.Pointer<ffi.Void> user)>;
typedef HMUSIC = DWORD;
typedef HRECORD = DWORD;
typedef RECORDPROC = ffi.NativeFunction<
    BOOL Function(HRECORD handle, ffi.Pointer<ffi.Void> buffer, DWORD length,
        ffi.Pointer<ffi.Void> user)>;
typedef HSYNC = DWORD;
typedef SYNCPROC = ffi.NativeFunction<
    ffi.Void Function(
        HSYNC handle, DWORD channel, DWORD data, ffi.Pointer<ffi.Void> user)>;
typedef HDSP = DWORD;
typedef DSPPROC = ffi.NativeFunction<
    ffi.Void Function(HDSP handle, DWORD channel, ffi.Pointer<ffi.Void> buffer,
        DWORD length, ffi.Pointer<ffi.Void> user)>;
typedef HFX = DWORD;
